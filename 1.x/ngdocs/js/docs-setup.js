NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "activated api attribute button buttons cancel case changing class complete component confirm content controller default define defined design directive editing example footer footers form framework global inherits kicks loaded method modal modals module multiple ng-click pattern pending process provided return risks rxmodalaction scope setstate standard submit subsequent takes template toggle tracked understand usage values views"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "api based component content directive example hide required role rxpermission service simple user"
    },
    {
      "section": "api",
      "id": "rxRadio",
    ...
    },
    {
      ...
      "keywords": "allow api behaves bind boolean box button capabilities classes clear cleared css custom customized customsearchmodel default described directive disabled disappear display element empty enable example filtering filterplaceholder html input model ng-disabled ng-model override placeholder rx-placeholder rxsearchbox search searchmodel string style styling text type"
    },
    {
      "section": "api",
      "id": "rxSelect",
    ...
    },
    {
      ...
      "keywords": "add api attribute column columns coming component correct defined demo directive ensures example note place predicate property referring representing reverse row rx-status-header rxstatuscolumn server sort sort-method sort-property sortable sortcol sorting status styling text thing"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$scope $watch api argument asynchronous attribute attributes automatically bind configurable defined directive disabled displays evaluate evaluated expression false false-value foo function indicates initialization input model ng-model note operation passed performs post-hook prevent property rxtoggleswitch scope set switch takes time toggle toggled toggles true true-value values written"
    },
    {
      "section": "api",
      "id": "tooltips",
      ...
      "keywords": "api applied attributes bootstrap component configuration creating custom dependency directive directives documentation elements encoreui exact example fine github guidance html included inside io optional overview plugin raw styles template templates tooltip tooltips usage work"
    },
    {
      "section": "api",
      "id": "typeahead",
